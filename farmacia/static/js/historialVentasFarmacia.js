...
function filtrar(nombre, fecha, inicio = "", fin = "") {
    const url = `/filtrar-ventas/?nombre=${encodeURIComponent(nombre)}&fecha=${fecha}&inicio=${inicio}&fin=${fin}&tipo=farmacia`;
            ...
            data.ventas.forEach(venta => {
                const fila = `
                    <tr class="main-row hover:bg-gray-200 rounded-lg transition-colors main-row">
                        ...
                        <td class="p-3 text-2xl text-center">${formatCurrency(venta.precioCompra)}</td>
